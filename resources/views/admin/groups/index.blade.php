        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <a href="{{ route('admin.groups.create') }}" class="btn btn-sm btn-primary font-weight-bold mb-3">Tambah
                        Data</a>
                            ...
                            <tbody>
                                @foreach ($groups as $group)
                                    <tr>
                                        ...
                                        <td><a href="{{ $group->image }}" target="_blank"><img src="{{ $group->image }}"
                                                    width="70px" height="70px" alt="No Image"></a></td>
                                        <td>
