        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <form class="form-vertical" action="{{ route('admin.groups.update', $group) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="description" placeholder="Masukkan Deskripsi Singkat grup">{{ $group->description }}</textarea>
                        </div>
                        <div class="form-group mb-4">
                            <label class="control-label">Url Gambar Group :</label>
                            <input type="text" name="image" class="form-control" value="{{ $group->image }}"
