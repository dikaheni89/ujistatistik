            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <a href="{{ route('admin.datasets.index') }}"
                        class="btn btn-sm btn-danger font-weight-bold mb-3">Kembali</a>
                            ...
                            <tbody>
                                @foreach ($datasets as $dataset)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.datasets.edit', $dataset->id) }}"
                                                class="btn btn-primary btn-sm font-weight-bold">Edit</a>
                                            <a href="{{ route('admin.resources.index', $dataset->id) }}"
                                                class="btn btn-warning btn-sm font-weight-bold">Resource</a>
                                            <form action="{{ route('admin.datasets.destroy', $dataset->id) }}"
