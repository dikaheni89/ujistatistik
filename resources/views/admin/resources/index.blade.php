...
@section('content')
    <div class="layout-px-spacing">
        ...
        <div class="d-flex justify-content-between mt-3">
            <a href="{{ route('admin.datasets.show', $dataset->organisation_id) }}"
                class="btn btn-sm btn-danger font-weight-bold float-end">Kembali</a>
            <a href="{{ route('admin.resources.create', $dataset->id) }}"
                                    ...
                                    <tbody>
                                        @foreach ($dataset->resources as $resource)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.resources.edit', $resource->resource_id) }}"
                                                        class="btn btn-sm btn-warning font-weight-bold">Edit</a>
                                                    <a href="{{ route('admin.resources.preview', $resource->resource_id) }}"
                                                        class="btn btn-sm btn-dark font-weight-bold">Download</a>
                                                    <form
                                                        action="{{ route('admin.resources.destroy', $resource->resource_id) }}"
