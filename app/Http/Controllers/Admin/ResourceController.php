...
class ResourceController extends Controller
{
    public function index($id)
    {
        ...
        return view('admin.resources.index', compact('dataset', 'title'));
    }
    //
    public function create($id)
    {
        ...
        return view('admin.resources.create', compact('dataset', 'title'));
    }
    //
    public function edit($id)
    {
        ...
        return view('admin.resources.edit', compact('title', 'resource'));
    }
    //
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                DB::commit();
                return redirect()->route('admin.resources.index', $resource->dataset_id)->with('success', 'Data berhasil diubah');
            } else {
                DB::rollBack();
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.resources.index', $id)->with('success', 'Data berhasil disimpan');
        } catch (\Exception $e) {
            DB::rollBack();
